...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Lab3Damped.jpg}
    \caption{In this photo is the final setup for the experiment used as a pendulum to create the oscillations. At the top of the setup is the Dual-Range Force sensor that was used as a fixed point that swings the ruler (the ruler is taped to the back of the Force Sensor) back and forth, it was also used as a dampening effect as there is screw on the top to which, when swung with the base of the screw acting as a friction force against the pole the pendulum swings on, dampening the oscillation. At the bottom of the pendulum, is attached with a Wireless Force Sensor acting as a measuring instrument to determine the Force over time, as well as a mass at the end of the pendulum weighing in 91.07 g.}
\end{figure}
